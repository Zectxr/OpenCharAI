...
class Chat(BaseCAI):
    def __init__(self, options: Dict):
        ...
        self.preferred_model_type: Optional[str] = options.get("preferred_model_type", None)
        self.model_preference_version: Optional[str] = options.get("model_preference_version", None)
